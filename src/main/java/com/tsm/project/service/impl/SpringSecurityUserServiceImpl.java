...
import com.tsm.project.repository.SpringSecurityRepository;

@Service("userDetailsService")
public class SpringSecurityUserServiceImpl implements UserDetailsService {

	@Autowired
	SpringSecurityRepository userRepo;
	...
	public UserDetails loadUserByUsername(final String username) throws UsernameNotFoundException {
		...
		List<GrantedAuthority> authorities = buildUserAuthority(user.getListOfUserRole());
